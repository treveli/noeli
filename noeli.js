...
var _user$project$Main$parallaxVid = function (video) {
	return A2(
			...
			_0: A3(
					...
					_0: _elm_lang$html$Html_Attributes$style(
						{
							...
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'min-height', _1: '300px'},
								_1: {ctor: '[]'}
							}
						}),
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: A2(_elm_lang$html$Html_Attributes$attribute, 'muted', 'true'),
								_1: {ctor: '[]'}
							}
						}
					}
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$src(video),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$style(
									{
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'type', _1: 'video/mp4'},
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html$text('Your browser does not support the video tag'),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
	...
	},
	{
		...
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('For booking and press inquiries, please complete this form'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('form here'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$Main$titlePage = A2(
		...
		_0: _elm_lang$html$Html_Attributes$style(
			{
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'background-image', _1: 'url(\"noeliflying.png\")'},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'background-size', _1: 'cover'},
								_1: {
	...
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Noeli Acoba'),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
...
var _user$project$Main$body = A2(
	...
	{
		ctor: '::',
		_0: _user$project$Main$titlePage,
		_1: {
			ctor: '::',
			_0: _user$project$Main$parallax('noelibricks.webp'),
			_1: {
				ctor: '::',
				_0: _user$project$Main$aboutMePage,
				_1: {
					ctor: '::',
					_0: _user$project$Main$parallaxVid('noeliloop.mp4'),
					_1: {
						ctor: '::',
...
var _user$project$Main$headerLink = function (title) {
	return A2(
		_elm_lang$html$Html$p,
		{
			ctor: '::',
...
var _user$project$Main$header = A2(
	...
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _user$project$Main$headerLink('Home'),
				_1: {
					ctor: '::',
					_0: _user$project$Main$headerLink('About'),
					_1: {
						ctor: '::',
						_0: _user$project$Main$headerLink('Photo Gallery'),
						_1: {
							ctor: '::',
							_0: _user$project$Main$headerLink('Video'),
							_1: {
								ctor: '::',
								_0: _user$project$Main$headerLink('Contact'),
								_1: {ctor: '[]'}
							}
						}
					}
